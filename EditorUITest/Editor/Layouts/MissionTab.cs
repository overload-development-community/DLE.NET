...
{
    public partial class MissionTab : DLELayoutableUserControl
    {
        public MissionTab()
        {
            InitializeLayout();
        ...
        public void InitializeLayout()
        {
            ...
            switch (this.DialogLayout)
            {
                ...
                case LayoutOrientation.VERTICAL_SS:
                    this.CopyLayout(typeof(VerticalMissionTab));
                    break;
                case LayoutOrientation.FLOATING:
                    this.CopyLayout(typeof(FloatingMissionTab));
                    break;
            }
        }
        ...
        {
            DoSelfTestFor(typeof(VerticalMissionTab), typeof(FloatingMissionTab));
        }
    }
}
