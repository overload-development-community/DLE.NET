...
{
    public partial class SettingsTab : DLELayoutableUserControl
    {
        public SettingsTab()
        {
            InitializeLayout();
        ...
        public void InitializeLayout()
        {
            ...
            switch (this.DialogLayout)
            {
                ...
                case LayoutOrientation.VERTICAL_SS:
                    this.CopyLayout(typeof(VerticalSettingsTab));
                    break;
                case LayoutOrientation.FLOATING:
                    this.CopyLayout(typeof(FloatingSettingsTab));
                    break;
            }
        }
        ...
        {
            DoSelfTestFor(typeof(VerticalSettingsTab), typeof(FloatingSettingsTab));
        }
    }
}
