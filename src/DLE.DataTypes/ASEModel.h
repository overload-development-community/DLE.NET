...
class CSubModel {
	...
	public:
		...
		void Init (void);
		void Destroy (void);
		int Read (IFileManager& fp, int& nVerts, int& nFaces);
		int SaveBinary (IFileManager& fp);
		int ReadBinary (IFileManager& fp);

	private:
		int ReadNode (IFileManager& fp);
		int ReadMeshVertexList (IFileManager& fp);
		int ReadMeshFaceList (IFileManager& fp);
		int ReadVertexTexCoord (IFileManager& fp);
		int ReadFaceTexCoord (IFileManager& fp);
		int ReadMeshNormals (IFileManager& fp);
		int ReadMesh (IFileManager& fp, int& nVerts, int& nFaces);
	};
...
class CModel {
	...
	private:
		int ReadTexture (IFileManager& fp, int nTexture);
		int ReadOpacity (IFileManager& fp, int nTexture);
		int ReadMaterial (IFileManager& fp);
		int ReadMaterialList (IFileManager& fp);
		int FindSubModel (const char *pszName);
		void LinkSubModels (void);
		int ReadSubModel (IFileManager& fp);
	};
