...
void CColor::Read (IFileManager& fp, bool bNewFormat)
{
...
void CColor::Write (IFileManager& fp, bool bFlag) 
{
...
void CVariableLight::Read (IFileManager* fp) 
{
CSideKey::Read (fp);
...
void CVariableLight::Write (IFileManager* fp) 
{
CSideKey::Write (fp);
...
switch (EditType ()) {
	...
	case opModify:
		...
		break;
	case opMove:
		*g_data.lightManager->VariableLight (Index ()) = *this;
		break;
	}
}
...
void CLightDeltaValue::Read (IFileManager* fp, bool bFlag)
{
...
void CLightDeltaValue::Write (IFileManager* fp, bool bFlag)
{
fp->Write (m_nSegment);
...
void CLightDeltaIndex::Read (IFileManager* fp, bool bD2X)
{
m_nSegment = fp->ReadInt16 ();
if (bD2X) {
...
void CLightDeltaIndex::Write (IFileManager* fp, bool bD2X)
{
fp->Write (m_nSegment);
if (bD2X)
...
{
m_nVariableLightIndex = g_data.lightManager->VariableLight (*this);
}
