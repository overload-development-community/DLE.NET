...
class CFaceVert {
	...
	public:
		int Read (IFileManager& cf, int bFlipV);
	};
...
class CFace {
	...
	public:
		int Read (IFileManager& cf, CSubModel *pso, CFaceVert *pfv, int bFlipV);
...
class CPoint {
	...
	public:
		int Read (IFileManager& cf, int bParent);
	};

class CPointList : public CDynamicArray<CPoint> {
	public:
		int Read (IFileManager& cf, int bParent, int nSize);
	};
...
class CAttachList : public CDynamicArray<CAttachPoint> {
	public:
		int Read (IFileManager& cf);
		int ReadNormals (IFileManager& cf);
	};
...
class CFrameInfo {
	...
	public:
		CFrameInfo () { Init (); }
		void Init (void);
		int Read (IFileManager& cf, CModel* po, int bTimed);
};
...
class CPosFrame {
	...
	public:
		int Read (IFileManager& cf, int bTimed);
...
class CModel {
	...
	private:
		...
		int ReadTextures (IFileManager& cf);
