...
public:
	...
	void ReadExtras (IFileManager* fp, bool bExtras);
	
	void WriteExtras (IFileManager* fp, bool bExtras);
...
private:
	ubyte ReadWalls (IFileManager* fp);

	ubyte WriteWalls (IFileManager* fp);
